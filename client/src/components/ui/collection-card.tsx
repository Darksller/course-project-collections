...
export function CollectionCard() {
  ...
  //TODO: fix bottom
  return (
    <div className="group relative m-auto h-[250px] w-[225px] cursor-pointer overflow-hidden rounded-md  border-purple-300 transition-all duration-500 hover:scale-105 hover:shadow-2xl">
      ...
      <Link to="$collection">
        <div className="group/img h-full overflow-hidden rounded-md bg-[url('image.jpg')] bg-cover  transition-all delay-1000 duration-1000">
          <div className="relative h-full w-full rounded-md bg-black/45  text-white opacity-0 transition-all duration-500 max-md:group-hover:opacity-100 md:group-hover/img:opacity-100">
            <div className="relative h-[80%] max-w-[92%] pl-5 font-under">
            ...
            <Link
              to="/tags/$tag"
              className="font-sans absolute bottom-2 left-3 max-w-[50%] translate-x-[-300%] overflow-hidden truncate rounded-lg border pl-2 pr-2 text-sm opacity-70 backdrop-blur transition-all duration-1000 hover:border-purple-500 hover:text-purple-500 group-hover/img:translate-x-0 group-hover:translate-x-0 dark:border-white"
            >
              #Овощи
            </Link>
            <Link
              to="/users/$userId"
              className="font-sans absolute bottom-2 right-3 max-w-[39%] translate-x-[300%] truncate rounded-lg border pl-2 pr-2 text-sm opacity-70 backdrop-blur transition-all  duration-1000 hover:border-purple-500 hover:text-purple-500 group-hover/img:translate-x-0 group-hover:translate-x-0 dark:border-white"
            >
              Петр
            </Link>
          </div>
