      ...
      <Link to={'/collections/$collectionId'} params={{ collectionId: id }}>
        <div className="group/img h-full overflow-hidden rounded-md bg-[url('@/assets/images/item.jpg')] bg-cover   transition-all delay-1000 duration-1000">
          <div className="relative h-full w-full rounded-md bg-black/45  text-white opacity-0 transition-all duration-500 max-md:group-hover:opacity-100 md:group-hover/img:opacity-100">
            ...
            <div className="absolute bottom-2 left-3 max-w-[50%] translate-x-[-300%] overflow-hidden truncate rounded-lg border pl-2 pr-2 text-sm opacity-70 backdrop-blur transition-all duration-1000 group-hover/img:translate-x-0 group-hover:translate-x-0 hover:opacity-100 dark:border-white">
              #Овощи
            </div>
            <div className="absolute bottom-2 right-3 max-w-[39%] translate-x-[300%] truncate rounded-lg border pl-2 pr-2 text-sm opacity-70 backdrop-blur transition-all  duration-1000 group-hover/img:translate-x-0 group-hover:translate-x-0 hover:opacity-100 dark:border-white">
              Петр
            </div>
          </div>
        </div>
