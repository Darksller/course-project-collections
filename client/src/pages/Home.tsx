    ...
    <div className="absolute top-0 w-full">
      <div className="sticky top-0 h-[100dvh] bg-purple-400 ">
        ...
        <div className="absolute top-[50%] z-[100] flex w-full translate-y-[-80%] flex-col  lg:left-[50%] lg:top-[50%] lg:translate-x-[-50%] lg:translate-y-[-80%] ">
          <div className="bg-white/40 p-4 text-left font-cgb text-5xl font-extrabold text-pink-500 backdrop-blur transition-all duration-500 lg:text-center lg:text-7xl dark:bg-pink-500/50 dark:text-white">
            {t(`main.enterText`)}
          </div>
