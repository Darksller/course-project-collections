...
export function Home() {
  return (
    <div className="absolute top-0 w-full">
      <div className="sticky top-0 h-[100svh]  bg-purple-400 ">
        <video
          src={intro}
          autoPlay
          loop
      ...
      <div className="sticky top-0 flex h-[100svh] max-w-full items-center justify-center bg-purple-400 brightness-50">
        <img
          src={secondImg}
          className="absolute left-0 top-0 h-full w-full object-cover"
        />
